...
| open-webui.commonEnvVars[0].name |  | `"HOST"` |
| open-webui.commonEnvVars[0].value |  | `"127.0.0.1"` |
| open-webui.commonEnvVars[1].name |  | `"WEBUI_AUTH_TRUSTED_EMAIL_HEADER"` |
| open-webui.commonEnvVars[1].value |  | `"X-Forwarded-Email"` |
| open-webui.commonEnvVars[2].name |  | `"WEBUI_AUTH_TRUSTED_NAME_HEADER"` |
| open-webui.commonEnvVars[2].value |  | `"X-Forwarded-Preferred-Username"` |
| open-webui.commonEnvVars[3].name |  | `"WEBUI_AUTH_TRUSTED_GROUPS_HEADER"` |
| open-webui.commonEnvVars[3].value |  | `"X-Forwarded-Groups"` |
...
| open-webui.commonEnvVars[6].name |  | `"ENABLE_LOGIN_FORM"` |
