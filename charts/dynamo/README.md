...
| global.postgresql.auth.postgresPassword | string | **required** | Password for postgresql |
| global.postgresql.auth.password | string | **required** | Password for openwebui database |
| global.redis.password | string | **required** | Redis password |
...
| osc-open-webui.open-webui.image.tag | string | `"0.11.4-osc-r1"` | The version of Open WebUI |
